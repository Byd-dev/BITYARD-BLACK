...
public class StockMarketFragment extends OBaseFragment implements View.OnClickListener {
   ...
   /* @BindView(R.id.swipeRefreshLayout)
    ...
    private void getQuote() {
        ...
        if (dataList != null) {
            ...
            oMarketAdapter.setDatas(OUserConfig.P_STOCKINDEX, dataList);
            oMarketAdapter.setStockDatas(OUserConfig.P_STOCKINDEX, oApiEntity.getStockIndexCommds());

...
public class MarketFragment extends OBaseFragment implements View.OnClickListener {
...
/*    @BindView(R.id.swipeRefreshLayout)
    ...
    private void getQuote() {
        ...
        if (dataList!=null){
            ...
            marketAdapter.setIsUpDown(isupdown);
            marketAdapter.setDatas(OUserConfig.P_ALLDEX, dataList);
            marketAdapter.setAllDatas(OUserConfig.P_ALLDEX, oApiEntity);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    marketAdapter.notifyItem(dataList);

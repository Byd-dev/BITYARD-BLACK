...
public class ForgetFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void postReset(final String num, final String pass, String code) {
        OkGo.<String>post(Constant.LOGIN_FORGET_URL)
    ...
    private void getCode(String username) {
     /*   HashMap map = new HashMap<>();
        ...
        okhttp3.Request request = new okhttp3.Request.Builder()
                .url(Constant.REGISTER_GETA_ARB_CODE_URL)
                .get()
                .post(requestBody)
                .build();

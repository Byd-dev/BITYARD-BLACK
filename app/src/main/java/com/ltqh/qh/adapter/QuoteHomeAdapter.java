...
import static com.ltqh.qh.utils.TradeUtil.listQuoteNameUSD;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (Integer.parseInt(tag) == 1) {
                ...
                ((MyViewHolder) holder).text_price.setTextColor(context.getResources().getColor(R.color.o_text_maincolor));

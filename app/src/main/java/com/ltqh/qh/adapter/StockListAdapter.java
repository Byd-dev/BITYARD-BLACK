...
public class StockListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_stocklist_layout, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            ((MyViewHolder) holder).text_high.setText(getNumberFormat2(datas.get(position).getHigh()));

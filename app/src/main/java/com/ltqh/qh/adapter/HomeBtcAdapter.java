...
public class HomeBtcAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_homebtc_layout, parent, false);

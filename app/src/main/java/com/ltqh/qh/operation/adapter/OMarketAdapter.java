...
public class OMarketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OMarketAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.o_item_market_layout, parent, false);
